...
public class AdminGuestLogController extends Controller {
...
//        System.out.println("Viewing more details for: " + guest.getGuestName());
        ...
        try {
            ...
            utils.switchScreenWithGuestLog("/com/bmh/hotelmanagementsystem/room/single-guest-log-view.fxml", primaryStage,guestLog, "/com/bmh/hotelmanagementsystem/room/admin-guest-logs-view.fxml");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
