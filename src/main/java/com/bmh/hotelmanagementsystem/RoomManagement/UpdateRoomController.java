...
public class UpdateRoomController extends Controller {
    ...
    public void setData(Object data, String previousLocation){
        ...
        room_number.setText("Update Room " + this.data.getRoomNumber() );
    }
    ...
    public void updateRoom(){
        ...
        confirmationAlert.setHeaderText("Are you sure you want to update this room?");
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            new Thread(() -> {
                try {
                    ...
                    String response = RestClient.post("/room/update", jsonString);
                    ...
                    if (apiResponse.getResponseHeader().getResponseCode().equals("00")) {
                        Platform.runLater(() -> {
                            loadingStage.close();
                            Utils.showAlertDialog(Alert.AlertType.INFORMATION, "Updated Successfully", "Room updated successfully");
                            primaryStage.close();
