...
public class GeneralAdminSingleRoomController extends Controller {
...
//    }
                    ...
                    Platform.runLater(() -> {
                        try {
                            if (apiResponse.getResponseHeader().getResponseCode().equals("00")) {
                                ...
                                Utils utils = new Utils();
                                utils.switchScreenWithData("/com/bmh/hotelmanagementsystem/room/general-admin-singleRoom-view.fxml", primaryStage,apiResponse.getData(), "/com/bmh/hotelmanagementsystem/room/general-admin-room-management-view.fxml");
                            } else {
                                loadingStage.close();
                                Alert errorAlert = new Alert(Alert.AlertType.ERROR);
    ...
    public void viewMaintenanceHistory(){
        try {
            Utils utils = new Utils();
            utils.switchScreenWithData("/com/bmh/hotelmanagementsystem/room/maintenance-history-view.fxml", primaryStage,currentRoom, "/com/bmh/hotelmanagementsystem/room/general-admin-room-management-view.fxml");
        } catch (Exception e) {
            e.printStackTrace();
            Utils.showGeneralErrorDialog();
        }
