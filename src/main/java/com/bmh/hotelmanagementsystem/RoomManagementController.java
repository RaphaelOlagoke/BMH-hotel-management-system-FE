...
import com.bmh.hotelmanagementsystem.BackendService.dto.RoomManagement;
...
public class RoomManagementController extends Controller{
    ...
    private void showRoomDetails(RoomManagement roomManagement) {
        ...
        try {
            ...
            utils.switchScreenWithData("/com/bmh/hotelmanagementsystem/room/singleRoom-view.fxml", primaryStage,room, "/com/bmh/hotelmanagementsystem/room-management-view.fxml");
        } catch (Exception e) {
            e.printStackTrace();
