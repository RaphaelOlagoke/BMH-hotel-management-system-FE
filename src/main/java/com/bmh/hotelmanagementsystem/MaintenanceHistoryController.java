...
import com.bmh.hotelmanagementsystem.BackendService.dto.GuestReservation;
import com.bmh.hotelmanagementsystem.BackendService.dto.MaintenanceRow;
...
//            utils.switchScreen(previousLocation, primaryStage);
            utils.switchScreenWithData("/com/bmh/hotelmanagementsystem/room/singleRoom-view.fxml", primaryStage,data, "/com/bmh/hotelmanagementsystem/room-management-view.fxml");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
