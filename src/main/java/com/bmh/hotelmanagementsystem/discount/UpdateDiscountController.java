...
public class UpdateDiscountController  extends Controller {
    ...
    public void setData(Object data, String previousLocation){
        this.data = (Discount) data;
        this.previousLocation = previousLocation;
        discount_code.setText(this.data.getCode());
        discount_code.setDisable(true);

        discount_percentage.setText(String.valueOf(this.data.getPercentage()));
        start_datePicker.setValue(this.data.getStartDate().toLocalDate());
        end_datePicker.setValue(this.data.getEndDate().toLocalDate());
        isActive_comboBox.setValue(this.data.isActive());
        isOneTimeUse_comboBox.setValue(this.data.isOneTimeUse());
    }
    ...
    public void initialize() {
        ...
        update.setOnAction(event -> updateDiscount());
    }
    ...
    public void updateDiscount(){
        ...
        confirmationAlert.setHeaderText("Are you sure you want to update this discount code?");
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            new Thread(() -> {
                try {
                    ...
                    request.setCode(this.data.getCode());
                    ...
                    String response = RestClient.post("/discount/update", jsonString);
